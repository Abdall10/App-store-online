    ...
    return (
        <div className="w-full bg-black py-2">
            <div className='container mx-auto flex items-center justify-center px-8'>
                <span className='text-center text-sm font-medium tracking-widest text-white'>
            ...
            <div className={`w-full transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-y-0' : '-translate-y-full'}`}>
                ...
                <Link href="#" className="absolute left-1/2 -translate-x-1/2">
                  <div className="flex items-center gap-2">
                    <span className="text-xl sm:text-2xl font-bold tracking-tight">Super Value</span>
                    <Image src="/logo.png" width={38} height={38} alt="Super Value" />
                  </div>
                </Link>
