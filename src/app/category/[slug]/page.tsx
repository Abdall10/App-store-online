...
import { getAllCategoryBySlug, getProductsByCategorySlug } from '@/sanity/lib/client';
...
const CategoryPage = async ({ params }: CategoryPageProps) => {
    ...
    const [category, products] = await Promise.all([getAllCategoryBySlug(slug), getProductsByCategorySlug(slug)]);
