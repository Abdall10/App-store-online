...
const freeShippingAmount = 15; // $15 for free
                                ...
                                <div className='divide-y'>
                                    {items.map((item) => (
                                        <div key={`cart-item-${item.id}`} className='flex gap-4 p-4 hover:bg-gray-50'>
                                                <div className='relative w-20 h-20 rounded-lg overflow-hidden flex-shrink border'>
                                                    <Image 
                                                    src={item.image} 
                                                    alt={item.title}
                                                    fill
                                        ...
                                        <div className='flex-1 min-w-0'>
                                            ...
                                            <div className='flex items-center gap-3 mt2'>
                                                <select
                                                value={item.quantity}
